...
export declare function bothWithInvalidFieldTracking<A, B>(validatorA: ValidatorWithTracking<A>, validatorB: ValidatorWithTracking<B>): (x: unknown, invalidFields?: Map<number, unknown[]>, level?: number) => x is A & B;
/**
